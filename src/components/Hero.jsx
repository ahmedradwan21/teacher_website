				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					<div className="order-2 lg:order-1">
						...
						<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
							...
							<span className="block text-xl md:text-2xl mt-3 text-gray-500 font-normal">
								مع مدرس يفهمك ويصبر عليك
							</span>
						</h1>

						<p className="text-gray-600 text-lg mb-8 max-w-lg leading-relaxed">
							أكتر من 500 طالب حققوا تحسناً ملحوظاً. جلسات فردية مخصصة، متابعة
							يومية، وضمان تحسن الدرجات في الرياضيات.
						</p>

						<div className="flex flex-wrap gap-4 mb-10">
							<a
								href="#booking"
								className="bg-primary-600 text-white px-8 py-4 rounded-2xl inline-flex items-center gap-2 hover:bg-primary-700 transition font-bold shadow-lg shadow-primary-500/25"
							>
							...
							<button
								...
								className="border-2 border-primary-200 text-primary-700 px-8 py-4 rounded-2xl inline-flex items-center gap-2 hover:bg-primary-50 transition font-bold bg-white"
							>
